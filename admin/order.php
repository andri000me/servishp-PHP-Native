                                    ...
                                    <tbody>
                                        ...
                                        foreach ($result as $value){
                                            ...
                                            <tr>
                                                ...
                                                <td nowrap="">
                                                    <center>
                                                        <a href="det_order.php?id=<?php echo $value['id_penjualan']; ?>"><button type="button" class="btn bg-green btn-circle waves-effect waves-circle waves-float waves-light" title="Detail Pembelian">
