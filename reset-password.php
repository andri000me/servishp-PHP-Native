...
<head>
    ...
    <title>Sign In | Teknisi Tamvan</title>
    <!-- Favicon-->
...
<body class="login-page" style="background-color: #FF6347;">
    <div class="login-box">
        <div class="logo">
        ...
        <div class="card">
            <div class="body">
                <form action="_update_pass.php" method="POST">
                    <div class="msg">Update Your Password to New Sign In</div>
